    ...
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-background">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <ElegantShape
          ...
          height={140}
          rotate={12}
          gradient="from-indigo-500/[0.15] dark:from-indigo-400/[0.15]"
        ...
        <ElegantShape
          ...
          height={120}
          rotate={-15}
          gradient="from-rose-500/[0.15] dark:from-rose-400/[0.15]"
        ...
        <ElegantShape
          ...
          height={80}
          rotate={-8}
          gradient="from-violet-500/[0.15] dark:from-violet-400/[0.15]"
        ...
        <ElegantShape
          ...
          height={60}
          rotate={20}
          gradient="from-amber-500/[0.15] dark:from-amber-400/[0.15]"
        ...
        <ElegantShape
          ...
          height={40}
          rotate={-25}
          gradient="from-cyan-500/[0.15] dark:from-cyan-400/[0.15]"
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center">
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-muted/20 border border-border/20 mb-8 md:mb-12"
          >
